...
public class Student implements Parcelable {
    ...
    public Student(String name, String surname, String brithDate) {
        Name = name;
        Surname = surname;
        BrithDate = brithDate;
    }

    public Student(String subject, String professor, String academicYear, String hoursOfLectures, String hoursOfPractice) {
        Subject = subject;
        Professor = professor;
    ...
    public Student(String name, String surname, String brithDate, String image) {
        Name = name;
        Surname = surname;
        BrithDate = brithDate;
        Image = image;
    ...
    public Student(Student firstStudent, Student secondStudent){
        Name = firstStudent.getName();
        Surname = firstStudent.getSurname();
        BrithDate = firstStudent.getBrithDate();
        Subject = secondStudent.getSubject();
        Professor = secondStudent.getProfessor();
        AcademicYear = secondStudent.getAcademicYear();
        HoursOfLectures = secondStudent.getHoursOfLectures();
        HoursOfPractice = secondStudent.getHoursOfLectures();
        Image = firstStudent.getImage();
    }
